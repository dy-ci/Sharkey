	...
	<div class="_spacer" style="--MI_SPACER-w: 700px;">
		<MkSwiper v-model:tab="tab" :tabs="headerTabs">
			...
			<div v-if="channel && tab === 'timeline'" class="_gaps">
				...
				<MkStreamingNotesTimeline :key="channelId + withRenotes + onlyFiles" src="channel" :channel="channelId" :withRenotes="withRenotes" :onlyFiles="onlyFiles" @before="before" @after="after" />
			</div>
