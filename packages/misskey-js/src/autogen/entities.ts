...
export type ILogtoReauthResponse = operations['i___logto___reauth']['responses']['200']['content']['application/json'];
...
export type ISetPasswordRequest = operations['i___set-password']['requestBody']['content']['application/json'];
