...
export type UsersListenbrainzRequest = operations['users___listenbrainz']['requestBody']['content']['application/json'];
export type UsersListenbrainzResponse = operations['users___listenbrainz']['responses']['200']['content']['application/json'];
